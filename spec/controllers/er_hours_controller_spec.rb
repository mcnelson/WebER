...
describe ErHoursController do

  # This should return the minimal set of attributes required to create a valid
  # ErHour. As you add validations to ErHour, be sure to
  ...
  # ErHoursController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all er_hours as @er_hours" do
      er_hour = ErHour.create! valid_attributes
      get :index, {}, valid_session
      assigns(:er_hours).should eq([er_hour])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested er_hour as @er_hour" do
      er_hour = ErHour.create! valid_attributes
      get :show, {:id => er_hour.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested er_hour as @er_hour" do
      er_hour = ErHour.create! valid_attributes
      get :edit, {:id => er_hour.to_param}, valid_session
      assigns(:er_hour).should eq(er_hour)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ErHour" do
        expect {
          post :create, {:er_hour => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved er_hour as @er_hour" do
        ...
        post :create, {:er_hour => {}}, valid_session
        assigns(:er_hour).should be_a_new(ErHour)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested er_hour" do
        ...
        put :update, {:id => er_hour.to_param, :er_hour => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested er_hour as @er_hour" do
        er_hour = ErHour.create! valid_attributes
        put :update, {:id => er_hour.to_param, :er_hour => valid_attributes}, valid_session
        assigns(:er_hour).should eq(er_hour)
      end
    ...
    describe "with invalid params" do
      it "assigns the er_hour as @er_hour" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ErHour.any_instance.stub(:save).and_return(false)
        put :update, {:id => er_hour.to_param, :er_hour => {}}, valid_session
        assigns(:er_hour).should eq(er_hour)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested er_hour" do
      er_hour = ErHour.create! valid_attributes
      expect {
        delete :destroy, {:id => er_hour.to_param}, valid_session
      }.to change(ErHour, :count).by(-1)
    end
    ...
    it "redirects to the er_hours list" do
      er_hour = ErHour.create! valid_attributes
      delete :destroy, {:id => er_hour.to_param}, valid_session
      response.should redirect_to(er_hours_url)
    end
  end
